...
`;
  return (
    <section className="py-20 md:py-24 mb- " ref={sectionRef}>
      <motion.div
        ref={borderedDivRef}
        animate={{
        ...
        className="container  group   border  border-white/15   py-28 rounded-xl overflow-hidden relative "
        style={{
          backgroundPositionY,
      ...
      >
        <div
          className="absolute inset-0 bg-[rgb(74,32,138)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_50%_46%,black,transparent)] group-hover:opacity-0 "
          style={{
